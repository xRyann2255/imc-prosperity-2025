...
class Trader:
    def __init__(self) -> None:
        ...
        self.strategies = {
            ...
            "SQUID_INK": SquidInkDeviationStrategy("SQUID_INK", limits["SQUID_INK"], n_days=210, z_high=2.5, z_low=1.5, profit_margin=9, sell_off_ratio=0.25, entering_aggression=1.6, take_profit_aggression=0, clearing_aggression=1, high_hold_duration=15000, low_hold_duration=8000, low_trade_ratio=0.5),

...
class Trader:
    def __init__(self):
        ...
        self.squid_ma_short = 10    # Short-term moving average period
        self.squid_ma_long = 45  # Long-term moving average period (mean to revert to)
        self.squid_z_threshold = 2  # Z-score threshold for entry
